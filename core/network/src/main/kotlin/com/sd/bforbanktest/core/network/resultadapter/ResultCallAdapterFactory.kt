package com.sd.bforbanktest.core.network.resultadapter
...
internal class ResultCallAdapterFactory @Inject constructor(private val moshi: Moshi) : CallAdapter.Factory() {
